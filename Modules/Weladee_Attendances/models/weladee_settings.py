...
CONST_SETTING_TIMESHEET_ACCOUNT_ANALYTIC_ACCOUNT_ID = 'weladee-timesheet_account_analytic_account_id'
    ...
    for dataSet in line_ids:
        if dataSet.key == CONST_SETTING_APIKEY :
            ...
            try:
                ...
                pass
        elif dataSet.key == CONST_SETTING_TIMESHEET_ACCOUNT_ANALYTIC_ACCOUNT_ID:
            try:
                ret.account_analytic_account_id = int(dataSet.value)
            except:
                pass
...
class weladee_settings(models.TransientModel):
    ...
    def saveBtn(self):
        ...
        self._save_setting(config_pool, CONST_SETTING_TIMESHEET_ACCOUNT_ANALYTIC_ACCOUNT_ID, self.account_analytic.account_id.id)
