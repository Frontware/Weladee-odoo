...
def sync_holiday_data(weladee_holiday, odoo_weladee_ids, context_sync, holiday_status_id, holiday_obj):
    '''
...
def sync_holiday(emp_obj, holiday_obj, authorization, context_sync, odoo_weladee_ids, holiday_status_id):
    '''
    ...
    try:
        ...
        for weladee_holiday in stub.GetHolidays(weladee_pb2.Empty(), metadata=authorization):
            ...
            if weladee_holiday and weladee_holiday.Holiday:
               ...
               odoo_hol = sync_holiday_data(weladee_holiday, odoo_weladee_ids, context_sync, holiday_status_id, holiday_obj)
