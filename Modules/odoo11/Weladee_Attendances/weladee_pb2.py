...
_EMPLOYEE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\nnationalid')), json_name='nationalid', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\005taxid')), json_name='taxid', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\017passport_number')), json_name='passport_number', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\025can_check_team_member')), json_name='can_check_team_member', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\006qrcode')), json_name='qrcode', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_EMPLOYEE.fields_by_name['nationalID'].has_options = True
_EMPLOYEE.fields_by_name['nationalID']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\nnationalid'))
_EMPLOYEE.fields_by_name['taxID'].has_options = True
_EMPLOYEE.fields_by_name['taxID']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\005taxid'))
_EMPLOYEE.fields_by_name['passportNumber'].has_options = True
_EMPLOYEE.fields_by_name['passportNumber']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\017passport_number'))
_EMPLOYEE.fields_by_name['CanCheckTeamMember'].has_options = True
_EMPLOYEE.fields_by_name['CanCheckTeamMember']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\025can_check_team_member'))
_EMPLOYEE.fields_by_name['QRCode'].has_options = True
_EMPLOYEE.fields_by_name['QRCode']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\006qrcode'))
