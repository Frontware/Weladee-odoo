...
from odoo.addons.Weladee_Attendances.models.sync.common import add_translation, lang_dict
    ...
    try:
        for weladee_skill_level in stub.GetSkillLevels(weladee_pb2.Empty(), metadata=req.config.authorization):
            ...
            if odoo_skill_level and odoo_skill_level['res-mode'] == 'create':
                ...
                if odoo_id.id:
                    odoo_id.with_context(updateLang=True).write(sync_clean_up(odoo_skill_level))
                    # Add translation
